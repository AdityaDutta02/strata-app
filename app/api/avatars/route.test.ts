...
describe('GET /api/avatars', () => {
  it('excludes an avatar whose latest avatar_create job is hidden', async () => {
    db.__seed('avatars', { id: 'a1', viewer_id: VIEWER, name: 'Old', status: 'ready' })
    db.__seed('avatars', { id: 'a2', viewer_id: VIEWER, name: 'Current', status: 'ready' })
    db.__seed('jobs', { viewer_id: VIEWER, type: 'avatar_create', input_json: { avatarId: 'a1' }, output_json: { hidden: true } })
    db.__seed('jobs', { viewer_id: VIEWER, type: 'avatar_create', input_json: { avatarId: 'a2' }, output_json: {} })
